...
import { PageSize, SourceObject, Style } from "@react-pdf-wasm/types";
...
declare const Document: typeof ReactPDFWasm.Document;
declare const Page: typeof ReactPDFWasm.Page;
declare const Image: typeof ReactPDFWasm.Image;
declare const Paragraph: typeof ReactPDFWasm.Paragraph;
declare const Link: typeof ReactPDFWasm.Link;
declare const Spacer: typeof ReactPDFWasm.Spacer;
declare const TableCell: typeof ReactPDFWasm.TableCell;
declare const TableRow: typeof ReactPDFWasm.TableRow;
declare const Table: typeof ReactPDFWasm.Table;

export default ReactPDFWasm;
